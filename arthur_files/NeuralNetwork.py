...
class nn:
    ...
    def fit(self, pb_train, sol_train, epochs, validation_split, callbacks):
        return self.model.fit(x=pb_train, y=sol_train, epochs=epochs, callbacks=callbacks, validation_split=validation_split)
    ...
    def train_with(self, initial_dataset_instance, epochs, validation_split, callbacks):
        ...
        history = self.fit(dataset_instance.get_RHS(), dataset_instance.get_solutions(), epochs=epochs,
                           validation_split=validation_split, callbacks=callbacks) # training the network
    ...
    def train_with_generator(self, generator, epochs, steps_per_epoch, validation_generator, callbacks):
        ...
        history = self.fit_generator(generator, epochs=epochs, steps_per_epoch=steps_per_epoch,
                                     validation_generator=validation_generator, callbacks=callbacks) # training the network
