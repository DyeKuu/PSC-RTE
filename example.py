...
### Creating the data
problem, N, dev, List = ["petit_probleme.lp"], 10, 0.1, [1, 2, 3, 4, 5, 6]  # Arguments for problem_generator
...
epochs = 10
neural_network = nn()
neural_network.basic_nn(
    layers_list)  # neural_network is now an instance of nn with the layers [Dense(100, relu), Dense(100, relu), Dense(1,  sigmoid)]

### training the neural network
analyze_set = neural_network.train_with(problem_set, epochs, validation_split=0)  # problem_set is an instance of dataset
